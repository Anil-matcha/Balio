...
{
	*/
[RequireComponent(typeof (PlayerLevel3))]
public class PlayerLevel3Control : MonoBehaviour
{
	private PlayerLevel3 m_Character;
	private bool m_Jump;
	public bool devtest = false;
	public bool playercanmove = true;
	private void Awake()
	{
		m_Character = GetComponent<PlayerLevel3>();
	}
